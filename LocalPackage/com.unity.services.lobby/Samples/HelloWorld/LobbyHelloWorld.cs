...
using Unity.Services.Lobby.Http;
using Unity.Services.Lobby.Models;
using Unity.Services.Lobby.Lobby;
...
public class LobbyHelloWorld : MonoBehaviour
{
    ...
    // Log in a player using Unity's "Anonymous Login" API and construct a Player object for use with the Lobby APIs
    ...
    static async Task<Lobby> JoinLobbyAsync(string lobbyId, Player player = null)
    {
        ...
        var request = new JoinLobbyRequest(new JoinRequest(
            id: lobbyId,
            lobbyCode: null,
            player: player));

        Response<Lobby> response = await LobbyService.LobbyApiClient.JoinLobbyAsync(request);
    ...
    static async Task<Lobby> GetLobbyAsync(string lobbyId)
    {
        ...
        Response<Lobby> response = await LobbyService.LobbyApiClient.GetLobbyAsync(new GetLobbyRequest(lobbyId));
        return response.Result;
    }
    ...
    static async Task DeleteLobbyAsync(string lobbyId)
    {
        ...
        Response response = await LobbyService.LobbyApiClient.DeleteLobbyAsync(new DeleteLobbyRequest(lobbyId));
